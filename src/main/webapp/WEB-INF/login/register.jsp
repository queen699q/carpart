...
$(document).ready(function(){
	...
	data:{"phone" : function(){return $("#telnum").val();}},
	success : function(data){	
	    if( data == "1" )
		{
	        return true;
    ...
    <div class="zhuce">
    	...
    	<form  method="post" id="registerForm" action="${ctx}/login/register">
        	<div class="zhuce_wid">
                ...
                <div class="f-cb zhuce_tt">
                    <span>手机号:</span>
                    <input type="text" placeholder="手机号" name="phone" id="telnum" autocomplete="off" >
                    <em>*</em>
                     <i id="telnumTip" style="font-size:14px;width:250px;font-style:normal;"></i>
                </div>
                <div class="f-cb zhuce_tt">
                    <span>验证码:</span>
                    <input id="code1" type="text" autocomplete="off" placeholder="短信验证码" onmouseout="binding()"/> <input id="btnSendCode1" type="button" class="btn btn-default" value="获取验证码" onClick="sendMessage1()"/>
                    <i id="tips" style="font-size:14px;width:250px;font-style:normal;"></i>
                </div>

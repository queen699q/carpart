        ...
        <div class="pagebody11_top"><!--输入用户名-->
            <form id="searchStaffForm" name="searchStaffForm" action="${ctx}/staff/staffList.shtml" method="post">
                <ul>
                    ...
                    <li ><input type="text" name="username" id="username" class="cha1"  value="${vo.username}"/></li>
        ...
        <div class="pagebody11_table">
            ...
            <div class="pagebody11_bg" style="height:500px">
                <table width="1000" border="0"  class="dsfd yuan" >
                    <c:forEach var="staff" items="${pageInfo.list}" varStatus="status">
                        <tr>
                        ...
                        <c:forEach begin="1" end="${pageInfo.pages}" var="pageNo">
                            <c:choose>
                                <c:when test="${pageNo==pageInfo.pageNum}">
                                    <a href="${ctx}/staff/staffList.shtml?pageNum=${pageNo}&pageSize=10" style="background: #C30D23 none repeat scroll 0% 0%;color:#ffffff;">${pageNo}</a>
                                </c:when>
                                <c:otherwise>
                                    <a href="${ctx}/staff/staffList.shtml?pageNum=${pageNo}&pageSize=10" >${pageNo}</a>
                                </c:otherwise>
                            </c:choose>

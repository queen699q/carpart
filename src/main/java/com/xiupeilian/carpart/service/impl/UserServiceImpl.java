...
public class UserServiceImpl implements UserService {
    ...
    public SysUser findUserByloginNameAndPassword(LoginVo vo) {
        return userMapper.finUserByLoginNameAndPassword(vo);
    }
    ...
    @Override
    public int findUserPgeCount(int cid) {
        return userMapper.findUserPgeCount(cid);
    }

    @Override
    public List<SysUser> findUserByNameAndPage(UserListVo vo) {
        return userMapper.findUserByNameAndPage(vo);
    }
